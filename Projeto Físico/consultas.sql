...
-- PROJETA AS PESSOAS QUE TEM MAIS DE UMA GANGUE
...
-- PROJETA AS PESSOAS QUE NÃO PERTENCEM A NENHUMA GANGUE
SELECT P.NOME
FROM PESSOA P
...
-- PROJETA OS NPCS QUE NÃO FORAM MORTOS POR NENHUM PROTAGONISTA
SELECT N.NOME
FROM NPC N
WHERE NOT EXISTS (
    SELECT *
...
-- PROJETA OS PROTAGONISTAS QUE DIRIGEM OS VEÍCULOS QUE TOCAM DETERMINADA MÚSICA
SELECT DISTINCT NOME_PROTAGONISTA
FROM DIRIGE
...
-- PROJETA OS NPCS QUE JÁ FORAM MORTOS TANTO PELO PROTAGONISTA Claude QUANTO PELO PROTAGONISTA Toni
SELECT NOME_NPC
FROM MATA
